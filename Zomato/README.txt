...
==========
	...
	curl -X GET http://asubbiay-lap1.oradev.oraclecorp.com/cities  -H 'Authorization: Bearer <ACCESS_TOKEN>'
	
	2. Get/Search the Restaurants
	curl -X GET http://asubbiay-lap1.oradev.oraclecorp.com/resturants/search?type=city&value=Bangalore&page=8&sort=cost&order=desc  -H 'Authorization: Bearer <ACCESS_TOKEN>'
	
	3. Get your Favourite Restaurants
	curl -X GET http://asubbiay-lap1.oradev.oraclecorp.com/favourite/  -H 'Authorization: Bearer <ACCESS_TOKEN>'
	
	4. Mark restaurant as favourite
	curl -X POST http://asubbiay-lap1.oradev.oraclecorp.com/favourite/<RESTAURANT_ID>  -H 'Authorization: Bearer <ACCESS_TOKEN>'
	...
	curl -X DELETE http://asubbiay-lap1.oradev.oraclecorp.com/favourite/<RESTAURANT_ID>  -H 'Authorization: Bearer <ACCESS_TOKEN>'
		*Error thrown no restaurants available in your list
		*Error thrown if requested restaurant not available
	
	6. Get your bookings
	curl -X GET http://asubbiay-lap1.oradev.oraclecorp.com/booking/  -H 'Authorization: Bearer <ACCESS_TOKEN>'
	
	7. Make bookings
	curl -X POST http://asubbiay-lap1.oradev.oraclecorp.com/booking  -H 'Authorization: Bearer <ACCESS_TOKEN>' -d '{
		"restaurantId": "24",
	...
	8. Cancel bookings
	curl -X DELETE http://asubbiay-lap1.oradev.oraclecorp.com/booking/<RESTAURANT_ID>  -H 'Authorization: Bearer <ACCESS_TOKEN>'
